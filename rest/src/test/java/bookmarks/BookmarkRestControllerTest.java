...
public class BookmarkRestControllerTest {
    ...
    void setConverters(HttpMessageConverter<?>[] converters) {
        List<HttpMessageConverter<?>> httpMessageConverters = Arrays.asList(converters);
        HttpMessageConverter mappingJackson2HttpMessageConverter = httpMessageConverters.stream().filter(
